...
// 项目引用 (Project References) 是 TypeScript 提供的组织大型项目的功能
// 允许将 TypeScript 项目拆分为更小的部分
...
// 项目引用 References 配置
// 在主项目的 tsconfig.json 中配置 references 字段，指向子项目的 tsconfig.json 文件
...
// 增量构建 (Incremental Build)：使用 -b (build) 选项时，TypeScript 会自动检测哪些项目需要重新编译
