...
// 递归类型 (Recursive Types) 是一种引用自身的类型，在处理树结构、嵌套数据时非常有用
...
//     console.log(indent + `Level: ${depth + 1} - ${node.name}`);
...
// console.log("数据库主机: " + partialConfig.database?.host);  // ?. 可选链访问
