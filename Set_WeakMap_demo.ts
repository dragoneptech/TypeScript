...
// 概念说明：Set 是值的集合，值唯一
// Map 是键值对集合，键可以是任意类型
// WeakSet 和 WeakMap 使用弱引用，不影响垃圾回收
...
// console.log("字符串 Set: " + JSON.stringify(Array.from(stringSet)));
...
// console.log("对象 Set: " + JSON.stringify(Array.from(personSet)));
...
// var weakSet: WeakSet<object> = new WeakSet();
...
// 注意：WeakSet 不能遍历，类型注解只能是 object
// 这使得 WeakSet 适合存储需要被垃圾回收的对象
