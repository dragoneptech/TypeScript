...
// 索引类型 (Indexed Access Types) 和 keyof 是 TypeScript 中操作对象类型的强大工具
...
// 索引访问类型
// type Value = User["name"] // string
// const userName: Value = "Alice"; // 正确
...
// 索引访问类型
// 使用索引访问类型（Indexed Access Type）可以获取对象属性的类型
...
// 获取 id 类型
// const idValue: UserId = getValue(user, "id");
// console.log("ID: " + idValue);

// 获取 name 类型
// const nameValue: UserName = getValue(user, "name");
...
// 泛型约束：K extends keyof T 确保传入的键一定是对象上存在的键，防止运行时错误
